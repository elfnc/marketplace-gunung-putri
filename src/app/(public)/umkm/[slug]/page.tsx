...
import { Store, MapPin, MessageCircle, ArrowLeft, ShoppingBag } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-8 md:py-12">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:items-start">
                ...
                <div className="flex-1 space-y-4">
                    ...
                    {/* Action Button */}
                    <div className="pt-2">
                         <Button asChild className="rounded-full bg-[#25D366] hover:bg-[#128C7E] text-white font-semibold shadow-sm">
                            <Link 
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 lg:grid-cols-4">
                {umkm.products.map((product) => (
                    <ProductCard
                        ...
                        // Info UMKM (diambil dari props product.umkm yang di-include tadi)
                        umkmName={product.umkm.name}
                        category={product.umkm.category.name}
                        umkmId={product.umkm.id}      // Wajib buat Cart
                        umkmPhone={product.umkm.phone} // Wajib buat Cart
